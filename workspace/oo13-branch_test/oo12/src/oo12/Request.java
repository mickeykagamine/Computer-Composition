			...
			while(true){			
				...
				if (FormCheck(request) == true){
					...
					if(!((Double.parseDouble(NewRequest[1]) == 0)
							...
							|(NewRequest[0].equals("FR") && Double.parseDouble(NewRequest[1]) == Floor.getfloormax() && NewRequest[2].equals("UP")))){
							if(NewRequest[0].equals("FR")){
							sign2 = SmarterController.judgefr(NewRequest[0],NewRequest[1],NewRequest[2],NewRequest[3],Queue.getQueue(),Controller.Max(Request.getLast()));
							...
							*/
							...
							sign2 =  SmarterController.judgeer(NewRequest[0],NewRequest[1],NewRequest[2],Queue.getQueue(),Controller.Max(Request.getLast()));
